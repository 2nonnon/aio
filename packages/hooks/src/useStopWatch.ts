...
import { cancelRaf, raf } from '@non/utils/src/raf'
import type { CurrentTime } from '@non/utils/src/time'
import { isSameSecond, parseTime } from '@non/utils/src/time'
...
export default function useStopWatch(options: UseStopWatchOptions = {}) {
